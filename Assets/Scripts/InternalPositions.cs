...
namespace Assets.Scripts
{
    public class InternalPositions
    {
        ...
        {
            ResourcesPositions = new Dictionary<Vector3, ResourceType>();
            CitiesPositions = new List<Vector3>();
        }
        public Vector3 InfluenceTilePosition { get; set; }
        public Vector3 TowerPosition { get; set; }
        public Dictionary<Vector3, ResourceType> ResourcesPositions { get; private set; }
        ...
        public void AddResource(Vector3 position, ResourceType resource)
        {
